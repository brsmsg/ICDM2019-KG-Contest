...
# 将tag转换成数字
tag2label = {"O": 0, "B-PER": 1, "I-PER": 2, "B-LOC": 3, "I-LOC": 4, "B-ORG": 5, "I-ORG": 6, 'B-MISC': 7, "I-MISC": 8}
...
def read_data(filename):
    ...
    for eachline in lines:
        if eachline != '\n':
            ...
            word = eachline.strip().split()[0]
            tag_ = eachline.strip().split()[3]
            # print(tag)下·
...
# data = read_data('eng.train')


def build_vocab(filenames, vocab_size=20000):
    '''
...
# content2id, label2id = sequence2id('eng.train')
# print(content2id)
